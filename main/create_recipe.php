                    ...
                    <div class="">
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="col-md-9">
                                ...
                                <h3>Rezeptname</h3>
                                <input required placeholder="Rezeptname" class="create-recipe-recipe-name"
                                       name="txtRezeptName" style="width: 100%;">
                                <br>
                                <br>
                                ...
                                <ul class="recipe-ul-styling">
                                    ...
                                    <div class="col-md-8">
                                        <div class="col-md-8" id="recipediv">
                                            ...
                                            <a href="javascript:AddFormField('forfields','text','','','li')">[Mehr
                                                Zutaten hinzufügen]</a>
                                        </div>
                                </ul>
                                <br>
                                <h3>Zubereitung</h3>
                                ...
                                <br>
                                <br>
                                <button type="submit" class="btn btn-blue btn-login" name="submit" value="Upload">Rezept
                                    erstellen
                                </button>
                            </div>
                        </form>
